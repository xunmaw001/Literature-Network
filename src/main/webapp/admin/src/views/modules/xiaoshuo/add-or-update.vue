    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="zuozheId" name="zuozheId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="小说名称" prop="xiaoshuoName">
                       <el-input v-model="ruleForm.xiaoshuoName"
                                 placeholder="小说名称" clearable  :readonly="ro.xiaoshuoName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="小说名称" prop="xiaoshuoName">
                           <el-input v-model="ruleForm.xiaoshuoName"
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xiaoshuoPhoto" label="小说照片" prop="xiaoshuoPhoto">
                        <file-upload
                            tip="点击上传小说照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiaoshuoPhoto" label="小说照片" prop="xiaoshuoPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="小说类型" prop="xiaoshuoTypes">
                        <el-select v-model="ruleForm.xiaoshuoTypes" :disabled="ro.xiaoshuoTypes" placeholder="请选择小说类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="小说类型" prop="xiaoshuoValue">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="小说原价" prop="xiaoshuoOldMoney">
                       <el-input v-model="ruleForm.xiaoshuoOldMoney"
                                 placeholder="小说原价" clearable  :readonly="ro.xiaoshuoOldMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="小说原价" prop="xiaoshuoOldMoney">
                           <el-input v-model="ruleForm.xiaoshuoOldMoney"
                                     placeholder="小说原价" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="小说介绍" prop="xiaoshuoContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiaoshuoContent" label="小说介绍" prop="xiaoshuoContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xiaoshuoPhoto: [
                              { required: true, message: '小说照片不能为空', trigger: 'blur' },
                          ],
                   xiaoshuoTypes: [
                   ...
                   xiaoshuoOldMoney: [
                              { required: true, message: '小说原价不能为空', trigger: 'blur' },
                   ...
                   xiaoshuoContent: [
                              { required: true, message: '小说介绍不能为空', trigger: 'blur' },
                          ],
                   shangxiaTypes: [
