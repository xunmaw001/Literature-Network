        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='xiaoshuo'">
                    <el-form-item class="select" v-if="type!='info'"  label="小说" prop="xiaoshuoId">
                        <el-select v-model="ruleForm.xiaoshuoId" :disabled="ro.xiaoshuoId" filterable placeholder="请选择小说" @change="xiaoshuoChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='xiaoshuo' ">
                    <el-form-item class="input" v-if="type!='info'"  label="小说名称" prop="xiaoshuoName">
                        <el-input v-model="xiaoshuoForm.xiaoshuoName"
                                  placeholder="小说名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='xiaoshuo' ">
                    <el-form-item class="input" v-if="type!='info'"  label="小说类型" prop="xiaoshuoValue">
                        <el-input v-model="xiaoshuoForm.xiaoshuoValue"
                                  placeholder="小说类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='xiaoshuo' ">
                    <el-form-item class="input" v-if="type!='info'"  label="小说原价" prop="xiaoshuoOldMoney">
                        <el-input v-model="xiaoshuoForm.xiaoshuoOldMoney"
                                  placeholder="小说原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   xiaoshuoId: [
                              { required: true, message: '小说不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
