...
//                            xiaoshuoEntity.setXiaoshuoName(data.get(0));                    //小说名称 要改的
//                            xiaoshuoEntity.setXiaoshuoPhoto("");//照片
//                            xiaoshuoEntity.setXiaoshuoTypes(Integer.valueOf(data.get(0)));   //小说类型 要改的
//                            xiaoshuoEntity.setXiaoshuoOldMoney(data.get(0));                    //小说原价 要改的
